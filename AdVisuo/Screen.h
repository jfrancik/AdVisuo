...
public:
	...
	enum VIEWPORTS { VP_FULL, VP_UP_LT, VP_UP_RT, VP_LW_LT, VP_LW_RT, VP_UP, VP_LW, VP_LT, VP_RT, VP_TRP_LT, VP_TRP_RT, VP_TRP_UP_LT, VP_TRP_UP_RT, VP_TRP_LW_LT, VP_TRP_LW_RT, VP_MAX };
