...
CRibbonScenarioButton::CRibbonScenarioButton(UINT nID, LPCTSTR lpszText, int nSmallImageIndex, int nLargeImageIndex, BOOL bRightAlignedText) :
...
CRibbonScenarioButton::CRibbonScenarioButton(UINT nID, LPCTSTR lpszText, int nSmallImageIndex, int nLargeImageIndex, UINT uiImagesPaletteResID,
...
void CRibbonScenarioButton::SetRightAlignedText(BOOL bSet)
{
...
void CRibbonScenarioButton::AddGroup(LPCTSTR lpszGroupName, UINT uiImagesPaletteResID, int cxPaletteImage, const CStringArray& arLabels)
{
...
void CRibbonScenarioButton::OnDrawPaletteIcon( CDC* pDC, CRect rectIcon, int nIconIndex, CMFCRibbonGalleryIcon* pIcon, COLORREF clrText)
{
	...
	bChecked = TRUE;
	bHighlighted = TRUE;
	// bHighlighted = (nIconIndex == 0 || nIconIndex == 4 || nIconIndex == 9);
...
void CRibbonScenarioButton::CopyFrom(const CMFCRibbonBaseElement& s)
{
	ASSERT_VALID(this);

	CMFCRibbonGallery::CopyFrom(s);
	CRibbonScenarioButton& src = (CRibbonScenarioButton&) s;
...
void CRibbonScenarioButton::UpdateToolTips()
{
