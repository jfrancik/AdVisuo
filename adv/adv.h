...
//	AVSetConnStrings(pConsoleConnectionString, pReportsConnectionString, pVisualisationConnectionString, pUsersConnectionString, pConnSimQueue)
...
// Reads IFC file and saves it vas a binary mesh file
// This function does not use databases
ADV_API HRESULT AVSaveIFCMesh(AVSTRING strIFCPathName, AVSTRING strMeshPathName = NULL);
ADV_API HRESULT AVSaveIFCMesh8(char *strIFCPathName, char *strMeshPathName = NULL);
