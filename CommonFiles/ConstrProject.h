...
public:
	...
	enum { MODEL_MACHINE, MODEL_BUFFER, MODEL_LIFT, MODEL_DOOR_CAR, MODEL_DOOR_LANDING };
	...
	virtual void BuildModel(AVULONG nModelId, AVSTRING strName, AVLONG nIndex, BOX box, AVVECTOR vecRot = Vector(0)) = 0;
