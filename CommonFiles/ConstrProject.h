...
public:
	...
	enum { MODEL_MACHINE, MODEL_OVERSPEED, MODEL_CONTROL_PANEL, MODEL_DRIVE_PANEL, MODEL_GROUP_PANEL, MODEL_ISOLATOR, MODEL_CWT, MODEL_RAIL, MODEL_BUFFER_CAR, MODEL_BUFFER_CWT, MODEL_PULLEY, MODEL_LADDER, MODEL_COMBINATION_BRACKET, MODEL_LIGHT,
